...
function ExtraSeats:__init()
    ...
    ExtraSeats:addSeats(57, 1) -- Sivirkin 15 Havoc Helicopter
    ExtraSeats:addSeats(34, 1) -- G9 Eclipse Fighter Jet
    ExtraSeats:addSeats(30, 1) -- Si-47 Leopard
...
function ExtraSeats:onPlayerEnterExtraSeatAttempt(vehicleId, player)
    ...
    player:SetValue("inextraseat", true)
...
function ExtraSeats:onPlayerLeaveExtraSeat(vehicleId, player)
    ...
    player:SetValue("inextraseat", false)
